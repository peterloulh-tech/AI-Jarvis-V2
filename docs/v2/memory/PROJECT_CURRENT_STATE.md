...
当前业务交付基线为 AIJARVISV2-22 提交 `361215800d79cef09910ac38e9b1d9538e85c38d`。项目记忆在其上独立收口，不改变该业务交付。
...
- O-C01 仅是唯一 PoC 准入组合，最终模型、量化和运行时仍未冻结；O10 的持续音画、自主触发、结构化三批输出与 16GB 独占组合能力尚无真机证据。Qwen2.5-Omni 候补还缺权重 revision/许可材料、自主触发、20 秒 16GB 与 Windows 自包含包证据。
