...
| AIJARVISV2-23 | O 双工与自主文字 PoC | `in_review` | O-C01、O10、P-01、O-RISK-23-01、阻塞 | 固定运行时前检通过，但模型/许可包、授权输入、Windows/NVIDIA 环境及三批记录入口缺失，动态闭环阻塞并进入选型风险评审。 | [tasks/AIJARVISV2-23.md](tasks/AIJARVISV2-23.md) |
