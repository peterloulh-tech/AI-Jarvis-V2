...
| AIJARVISV2-26 | V 多图单次结构化输出 PoC | `in_review` | required、allow_silence、Qwen、MiniCPM、1/2/3 图 | Qwen/MiniCPM 使用共同 v3 合同，Mac 功能硬门均 9/9；Windows/NVIDIA 与真实语料待验证。 | [tasks/AIJARVISV2-26.md](tasks/AIJARVISV2-26.md) |
