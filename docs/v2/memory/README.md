...
| AIJARVISV2-23 | O 双工与自主文字 PoC | `in_review` | O-C01、O10、P-01～04、Windows 现场包、O-RISK-23-01 | 已补齐单入口动态采集包；模型许可包、授权输入和 Windows/NVIDIA 真机仍缺，动态闭环保持阻塞。 | [tasks/AIJARVISV2-23.md](tasks/AIJARVISV2-23.md) |
