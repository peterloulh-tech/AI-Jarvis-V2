...
| AIJARVISV2-14 | Windows 真机矩阵 | `in_review` | 8/12/16GB、显示音频、断网、同机负载 | 编排代表性 Windows/NVIDIA 真机、显示/输入、系统状态和英雄联盟同机验收组合。 | [tasks/AIJARVISV2-14.md](tasks/AIJARVISV2-14.md) |
