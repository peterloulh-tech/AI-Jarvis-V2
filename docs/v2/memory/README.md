...
| AIJARVISV2-25 | V 模型与运行时候选 | `in_progress` | V-C01、Qwen3-VL-4B、llama-server、shared slots、multi-image | 推荐单模型共享 slots 的 Qwen3-VL/llama.cpp PoC 路线，固定官方 revision、淘汰边界与任务 26/27 动态验证方案；本轮待证据评论后移入评审。 | [tasks/AIJARVISV2-25.md](tasks/AIJARVISV2-25.md) |
