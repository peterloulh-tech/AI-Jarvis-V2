...
要求：DATA-001～017 逐项记录；不适用项说明依据。原始音画的持久化、Local 上传及 Online 授权上传结果另在第 5 节记录；持久化与 Local 上传预期为 0，Online 按开始/暂停/停止窗口判定。
...
|---|---|---|---|---|---|
| PRIV-NFR-001～012 | | | | | |
| AC-D01 无自动上传 | NET-TEST-001/002/004 | Local 外部连接与自动上传 0；Online 仅在授权运行窗口连接已选 Provider | | | |
| AC-D02 原始音画不落盘 | DISK-TEST-001～003；NET-TEST-004 | 持久化 0；Local 上传 0；Online 仅必需载荷且停止后 0 | | | |
